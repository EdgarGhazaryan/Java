...
import homeworks.project.model.User;
...
public class UserService implements DatabasePaths {
    ...
    public boolean login() {
        ...
        for (String line : lines) {
            //Full Name , Username, Email , MD5(password)
            String[] fields = line.split(",");
            if (fields[1].equals(username) && fields[3].equals(password)) {
                System.out.println("Hi " + fields[0] + ". You have successfully registered");
                return true;
            }
        }
